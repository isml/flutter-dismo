...
print("Volume                                  = {0}".format(volume2))
print("Position of the center of gravity (COG) = {0}".format(cog2))
print("Inertia matrix at expressed at the COG  = {0}".format(inertia[0,:]))
print("                                          {0}".format(inertia[1,:]))
print("                                          {0}".format(inertia[2,:]))
...
print(ox,oy,oz)
print(c1.vectors[0],"c1 ilk hali")
for i in c1.vectors:
...
if(zTopOran<0):
    zTopOran=zTopOran*-1;
print("x lerin toplamının oranı : ",xTopOran,"y lerin toplamının oranı : ",yTopOran,"z lerin toplamının oranı : ",zTopOran,)
#oranlar negatifse pozitife dönüştürlecek


print("c1x top : ",c1xTop,"c2x top :",c2xTop)
print("c1y top : ",c1yTop,"c2y top :",c2yTop)
print("c1z top : ",c1zTop,"c2z top :",c2zTop)
#print("list2",list2)
distanceList = []

tempList =[]
print(len(list1),len(list2))
print("buraya bakkkkkkk",list1[0][2],list2[0][2])
kucukList=list1
if(len(list2)<len(list1)):
    kucukList=list2
for k in range(len(kucukList)):
  #  print("d hesaplamanın içindeyim")
    #print(list1[k][0],list2[k][0],list1[k][1] , list2[k][1],list1[k][2] , list2[k][2])
    ...
    #print("orijinal dliste eleman eklendi")
    tempList.clear()
#print("d bulma bitti",distanceList)
#print(distanceList)
...
print("mesafe bilgilerii : ",onePerH," ",twoPerH," ",fourPerH," ",sixPerH);
...
print("oriPuannnn eklenmemiş",oriPuan)
if(oriPuan<=50):
    oriPuan+=(facesOran*10)
    print("oriPuannnn 1.ekleme", oriPuan)
    if(VolumeOran>=0.7):
        oriPuan+=(VolumeOran*10)
        print("oriPuannnn 2.ekleme", oriPuan)
elif(50<oriPuan<70):
    oriPuan+=(VolumeOran*5)
    print("oriPuannnn 3.ekleme", oriPuan)
    oriPuan+=(facesOran*5)
    print("oriPuannnn 4.ekleme", oriPuan)
if(oriPuan<0):
    oriPuan*=-1
    print("oriPuannnn 5.ekleme", oriPuan)
    ...
    print("oriPuannnn 6.ekleme", oriPuan)

print("Volume oran:",VolumeOran,"FacesOran:",facesOran)
if(VolumeOran>=0.9 and facesOran>=0.9 and oriPuan<=45):

    oriPuan += (VolumeOran * 10)
    print("oriPuannnn 7.ekleme", oriPuan)
    oriPuan += (facesOran * 10)
    print("oriPuannnn 8.ekleme", oriPuan)
...
if(45<=oriPuan<=70 and VolumeOran>=0.95 and facesOran>=0.95):
    oriPuan=oriPuan+10;
print("oriPuannnn eklenmiş",oriPuan)
...
if(oranKontrolSayi==3 and 50<=oriPuan<=80):
    ...
    oriPuan+=3;
print("Son eklenmiş OriPuan",oriPuan);
#yeni puanlama deneme bitiş
print(twoPerH,fourPerH,sixPerH)
